...
<head>
    ...
    <title>Medsync | Painel do Paciente</title>
...
<body>
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="agendar-consulta.php">Agendar Consulta</a></li>
            <li><a href="atestados.php">Seus Atestados</a></li>
    ...
    <div class="main-container">
        <div class="carrossel-painel">
            <div class="slides">
                <div class="slide"><img src="../images/painel_paciente/carrossel1.png" alt="Slide 1"></div>
                <div class="slide"><img src="../images/painel_paciente/carrossel2.png" alt="Slide 2"></div>
                <div class="slide"><img src="../images/painel_paciente/carrossel3.png" alt="Slide 3"></div>
            </div>
            ...
            <div class="card-conteudo">
                <?php
                    ...
                    $sql = "SELECT cm.data_consulta, cm.hora_consulta, cm.status, 
                            ...
                            WHERE cm.paciente_maior_id = $pmaior_id 
                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        echo '<p>Seu próximo compromisso:</p>';
