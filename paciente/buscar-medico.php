...
// Lista fixa de especialidades em ordem alfabética (TODAS as especialidades)
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="doctor-card">
                            ...
                            <div class="d-flex gap-2">
                                <a href="agendar-consulta.php?medico_id=<?php echo $medico['medicos_id']; ?>" 
...
<script>
    // Adiciona confirmação ao agendar consulta
    document.addEventListener('DOMContentLoaded', function() {
        const agendarButtons = document.querySelectorAll('a[href*="agendar-consulta.php"]');
        agendarButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                if (!confirm('Deseja ser redirecionado para a página de agendamento com este médico?')) {
                    e.preventDefault();
                }
            });
        });
