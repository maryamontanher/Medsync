...
// Buscar receitas do paciente (maior de idade)
$sql = "
...
<nav class="navbar">
    ...
    <ul class="nav-links">
        <?php if ($tem_dependentes): ?>
            <li><a href="receitas-menor.php"><i class="fas fa-child me-1"></i>Receitas dos Dependentes</a></li>
        <?php endif; ?>
        <li>
...
<script>
    ...
    // Função para imprimir receita (a terminar)
    ...
    // mostrar apenas receitas válidas
